    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4">
        <form onSubmit={handleLogin} className="bg-slate-900 p-8 md:p-10 rounded-[2.5rem] w-full max-w-md border border-slate-800 shadow-2xl">
          <h2 className="text-2xl md:text-3xl font-black mb-8 text-white uppercase tracking-tighter text-center italic">Bishnupriya <span className="text-emerald-500 text-xs block tracking-widest mt-1 not-italic">Admin Access</span></h2>
