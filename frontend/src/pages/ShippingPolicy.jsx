...
const ShippingPolicy = () => (
  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-4xl mx-auto py-24 px-6 min-h-screen">
    ...
    <div className="space-y-8 text-slate-600 dark:text-slate-400 leading-relaxed">
      <section>
        <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Order Processing</h2>
        <p>All orders are processed within 1-2 business days. Orders are not shipped or delivered on weekends or public holidays.</p>
      </section>
      <section>
        <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Shipping Rates & Delivery Estimates</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Shipment Confirmation & Order Tracking</h2>
