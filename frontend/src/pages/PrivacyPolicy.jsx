...
const PrivacyPolicy = () => (
  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-4xl mx-auto py-20 px-6">
    ...
    <div className="space-y-6 text-slate-600 dark:text-slate-400">
      <p>Bishnupriya Electrical ("we", "our", "us") is committed to protecting your privacy. This policy explains how we collect, use, and disclose your personal information.</p>
      ...
      <h2 className="text-xl font-bold text-slate-900 dark:text-white">Payment Security</h2>
