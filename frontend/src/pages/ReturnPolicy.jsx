...
const ReturnPolicy = () => (
  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-4xl mx-auto py-20 px-6">
    ...
    <div className="space-y-6 text-slate-600 dark:text-slate-400 leading-relaxed">
      <section>
        <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">1. Returns</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">2. Refunds</h2>
      ...
      <section>
        <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-2">3. Shipping Returns</h2>
